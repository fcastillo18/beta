...
public class FindUser extends javax.swing.JFrame {
    ...
    public FindUser() {
        initComponents();
        try {
            tblUser.setModel(mn.getUsersModel(mn.queryToDB("select * from tbl_User")));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            tblUser.setModel(mn.getUsersModel(mn.queryToDB("select * from tbl_User where usUserName LIKE '%"+jTextField1.getText().trim()+"%' OR usFirstName LIKE '%"+jTextField1.getText().trim()+"%' OR usLastName LIKE '%"+jTextField1.getText().trim()+"%'")));
        } catch (SQLException ex) {
            Logger.getLogger(FindUser.class.getName()).log(Level.SEVERE, null, ex);
        }
